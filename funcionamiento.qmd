...
\begin{table}[H]
    ...
    \begin{tabular}{|p{35mm}|p{35mm}|p{35mm}|p{35mm}|}
        \hline
        & \textbf{Sin cambio en la demanda} & \textbf{Incremento en la demanda} & \textbf{Decremento en la demanda} \\ \hline
        \textbf{Sin cambio en la oferta} & 
        $P$ igual \newline $Q$ igual & 
        $P$ aumenta \newline $Q$ aumenta & 
        $P$ disminuye \newline $Q$ disminuye \\ \hline
        \textbf{Incremento en la oferta} & 
        $P$ aumenta \newline $Q$ disminuye & 
        $P$ aumenta \newline $Q$ ambiguo & 
        $P$ ambiguo \newline $Q$ disminuye \\ \hline
        \textbf{Decremento en la oferta} & 
        $P$ disminuye \newline $Q$ aumenta & 
        $P$ ambiguo \newline $Q$ aumenta & 
        $P$ disminuye \newline $Q$ ambiguo \\ \hline
    \end{tabular}
    \caption{Comparación entre cambios en la oferta y la demanda.}
    \label{tab:comparativa_oferta_demanda}
\end{table}
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Tabla Oferta y Demanda</title>
    <style>
        table {
            border-collapse: collapse;
            width: 100%;
...
<body>
    <table>
        <caption><strong>Comparación entre cambios en la oferta y la demanda</strong></caption>
        <tr>
            <th></th>
            <th>Sin cambio en la demanda</th>
            <th>Incremento en la demanda</th>
            <th>Decremento en la demanda</th>
        </tr>
        <tr>
